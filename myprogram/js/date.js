        ...
        calendarSwitch.prototype = { /*说明：初始化插件*/
            ...
            init: function() {
                ...
                for (var q = 0; q < me.index; q++) {
					...
					var startWeek=currentDate.getDay();
                        ...
                        if ($(this).text() == '离店') {
                            ...
                            $(me.sections).find('.tbody .rz').each(function(index, element) {
                                if ($(this).text() == '入住') {
                                    ...
                                    //添加入住到input
                                    $('#startDate').val(startDayMonth + day + '日');
									var startDayMonth=parseInt(startDayMonth);
									var as = new Date(startDayMonth+' '+day+' '+startDayYear).getDay();
									var str='周';
									switch (as) {  
									    case 0 :  
												str += "日";  
                                ...
                                if ($(this).text() == '离店') {
                                    ...
                                    //添加入住到input
                                    $('#endDate').val(endDayMonth + '' + day +'日');
									var endDayMonth=parseInt(endDayMonth);
									var endWeek = new Date(endDayMonth+' '+day+' '+endDayYear).getDay();
									var str1='周';
									switch (endWeek) {  
									    case 0 :  
												str1 += "日";  
